                ...
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        ...
                        <button type="button" class="btn btn-secondary btn-air-secondary mx-2"
                            wire:click="$toggle('toggle_entry_modal')">Add Journal Entry</button>
                    </div>
                </div>
            </div>
            ...
            <div class="card"
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-lg-6">
                            <label
                                for="ledger_account">{{ label('entries', 'ledger_account', 'Ledger Account') }}</label>
                            <select wire:model.debounce.500ms="ledger_account" class="form-control">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">
                                    <select wire:model.debounce.500ms="account_type" class="form-control">
                ...
                <div class="card-footer">
                    <button type="button" class="btn btn-success btn-air-success"
                        wire:click="{{ !is_null($edit_entry) ? 'update' : 'save' }}">{{ !is_null($edit_entry) ? 'Update' : 'Save' }}</button>
